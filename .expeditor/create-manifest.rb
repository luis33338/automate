...
unless no_pin_hab
  ...
  pins["hab"]          = { "origin" => "core", "name" => "hab",          "version" => "1.6.267", "release" => "20210304183447"}
  pins["hab-sup"]      = { "origin" => "core", "name" => "hab-sup",      "version" => "1.6.267", "release" => "20210304191502"}
  pins["hab-launcher"] = { "origin" => "core", "name" => "hab-launcher", "version" => "15249",  "release" => "20210304191504"}
end
